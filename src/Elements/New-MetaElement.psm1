...
function New-HtmlMetaElement: NewElementCommand("meta", isVoid: true) {
	...
	#>
	[Parameter(Mandatory, ParameterSetName = nameof(Charset), ValueFromPipelineByPropertyName)]
	...
	#>
	[Parameter(Mandatory, ParameterSetName = nameof(HttpEquiv), ValueFromPipelineByPropertyName)]
	[Parameter(Mandatory, ParameterSetName = nameof(Name), ValueFromPipelineByPropertyName)]
